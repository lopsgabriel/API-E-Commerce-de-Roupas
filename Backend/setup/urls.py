...
from perfil.views import PerfilViewSet,ItemCarrinhoViewSet, ListaCarrinhoViewSet, ListaDesejosViewSet
...
router.register('listaDesejos', ListaDesejosViewSet, basename='ListaDesejos')
urlpatterns = [
